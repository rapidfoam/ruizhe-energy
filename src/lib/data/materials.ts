...
export const WALL_TYPES: WallType[] = [
  ...
  { id: "light_wood_wall", name: "轻型木结构墙体", lambda: 0.14, lambdaCorrection: 1.10, lambdaCorrected: 0.154, density: 500, description: "木龙骨+OSB板+石膏板", thicknesses: [120, 170] },
  { id: "light_steel_wall", name: "轻型钢结构板墙体", lambda: 0.20, lambdaCorrection: 1.10, lambdaCorrected: 0.22, density: 800, description: "轻钢龙骨+水泥纤维板", thicknesses: [120, 170] },
];
